...
import { PhButton, PhButtonList, PhForm, PhInput, PhSelectItem, PhSelectList, PhSlider, PhTextarea, PhWindow } from "@phobos/elements";
...
@Component({
  ...
  imports: [CommonModule, PhButton, PhButtonList, PhForm, PhInput, PhSlider, PhTextarea, PhSelectList, PhSelectItem, PhWindow],
})
