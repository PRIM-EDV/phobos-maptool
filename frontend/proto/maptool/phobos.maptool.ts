...
export const Request: MessageFns<Request> = {
  encode(message: Request, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.setMapEntity !== undefined) {
      SetMapEntity_Request.encode(message.setMapEntity, writer.uint32(10).fork()).join();
    }
    if (message.deleteMapEntity !== undefined) {
      DeleteMapEntity_Request.encode(message.deleteMapEntity, writer.uint32(18).fork()).join();
    }
    if (message.getAllMapEntities !== undefined) {
      GetAllMapEntities_Request.encode(message.getAllMapEntities, writer.uint32(26).fork()).join();
    }
    if (message.setSquad !== undefined) {
      SetSquad_Request.encode(message.setSquad, writer.uint32(114).fork()).join();
    }
    if (message.deleteSquad !== undefined) {
      DeleteSquad_Request.encode(message.deleteSquad, writer.uint32(122).fork()).join();
    }
    if (message.getAllSquads !== undefined) {
      GetAllSquads_Request.encode(message.getAllSquads, writer.uint32(130).fork()).join();
    }
    return writer;
  },
...
export const Response: MessageFns<Response> = {
  encode(message: Response, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.setMapEntity !== undefined) {
      SetMapEntity_Response.encode(message.setMapEntity, writer.uint32(10).fork()).join();
    }
    if (message.deleteMapEntity !== undefined) {
      DeleteMapEntity_Response.encode(message.deleteMapEntity, writer.uint32(18).fork()).join();
    }
    if (message.getAllMapEntities !== undefined) {
      GetAllMapEntities_Response.encode(message.getAllMapEntities, writer.uint32(26).fork()).join();
    }
    if (message.setSquad !== undefined) {
      SetSquad_Response.encode(message.setSquad, writer.uint32(114).fork()).join();
    }
    if (message.deleteSquad !== undefined) {
      DeleteSquad_Response.encode(message.deleteSquad, writer.uint32(122).fork()).join();
    }
    if (message.getAllSquads !== undefined) {
      GetAllSquads_Response.encode(message.getAllSquads, writer.uint32(130).fork()).join();
    }
    return writer;
  },
...
export const MaptoolMessage: MessageFns<MaptoolMessage> = {
  encode(message: MaptoolMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MaptoolMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
