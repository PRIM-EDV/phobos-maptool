...
export const SquadDto: MessageFns<SquadDto> = {
  encode(message: SquadDto, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SquadDto {
...
export const GetAllSquads: MessageFns<GetAllSquads> = {
  encode(message: GetAllSquads, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.request !== undefined) {
      GetAllSquads_Request.encode(message.request, writer.uint32(10).fork()).join();
    }
    if (message.response !== undefined) {
      GetAllSquads_Response.encode(message.response, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetAllSquads {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetAllSquads_Request: MessageFns<GetAllSquads_Request> = {
  encode(_: GetAllSquads_Request, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetAllSquads_Request {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetAllSquads_Response: MessageFns<GetAllSquads_Response> = {
  encode(message: GetAllSquads_Response, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.squads) {
      SquadDto.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetAllSquads_Response {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetSquad: MessageFns<SetSquad> = {
  encode(message: SetSquad, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.request !== undefined) {
      SetSquad_Request.encode(message.request, writer.uint32(10).fork()).join();
    }
    if (message.response !== undefined) {
      SetSquad_Response.encode(message.response, writer.uint32(18).fork()).join();
    }
    if (message.error !== undefined) {
      writer.uint32(26).string(message.error);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetSquad {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetSquad_Request: MessageFns<SetSquad_Request> = {
  encode(message: SetSquad_Request, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.squad !== undefined) {
      SquadDto.encode(message.squad, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SetSquad_Request {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetSquad_Response: MessageFns<SetSquad_Response> = {
  encode(_: SetSquad_Response, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SetSquad_Response {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DeleteSquad: MessageFns<DeleteSquad> = {
  encode(message: DeleteSquad, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.request !== undefined) {
      DeleteSquad_Request.encode(message.request, writer.uint32(10).fork()).join();
    }
    if (message.response !== undefined) {
      DeleteSquad_Response.encode(message.response, writer.uint32(18).fork()).join();
    }
    if (message.error !== undefined) {
      writer.uint32(26).string(message.error);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteSquad {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DeleteSquad_Request: MessageFns<DeleteSquad_Request> = {
  encode(message: DeleteSquad_Request, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.squad !== undefined) {
      SquadDto.encode(message.squad, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteSquad_Request {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DeleteSquad_Response: MessageFns<DeleteSquad_Response> = {
  encode(_: DeleteSquad_Response, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DeleteSquad_Response {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
