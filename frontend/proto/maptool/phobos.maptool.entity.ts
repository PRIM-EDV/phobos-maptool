...
export const MapEntityDto: MessageFns<MapEntityDto> = {
  encode(message: MapEntityDto, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
    ...
    if (message.position !== undefined) {
      MapEntityDto_Position.encode(message.position, writer.uint32(26).fork()).join();
    }
    if (message.squad !== undefined) {
      MapEntityDto_Squad.encode(message.squad, writer.uint32(34).fork()).join();
    }
    if (message.enemy !== undefined) {
      MapEntityDto_Enemy.encode(message.enemy, writer.uint32(42).fork()).join();
    }
    if (message.objective !== undefined) {
      MapEntityDto_Objective.encode(message.objective, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MapEntityDto {
...
export const MapEntityDto_Squad: MessageFns<MapEntityDto_Squad> = {
  encode(message: MapEntityDto_Squad, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MapEntityDto_Squad {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MapEntityDto_Enemy: MessageFns<MapEntityDto_Enemy> = {
  encode(message: MapEntityDto_Enemy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.combattants !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MapEntityDto_Enemy {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MapEntityDto_Objective: MessageFns<MapEntityDto_Objective> = {
  encode(message: MapEntityDto_Objective, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MapEntityDto_Objective {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MapEntityDto_Position: MessageFns<MapEntityDto_Position> = {
  encode(message: MapEntityDto_Position, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.x !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MapEntityDto_Position {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DeleteMapEntity: MessageFns<DeleteMapEntity> = {
  encode(message: DeleteMapEntity, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.request !== undefined) {
      DeleteMapEntity_Request.encode(message.request, writer.uint32(10).fork()).join();
    }
    if (message.response !== undefined) {
      DeleteMapEntity_Response.encode(message.response, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteMapEntity {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DeleteMapEntity_Request: MessageFns<DeleteMapEntity_Request> = {
  encode(message: DeleteMapEntity_Request, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.entity !== undefined) {
      MapEntityDto.encode(message.entity, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DeleteMapEntity_Request {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DeleteMapEntity_Response: MessageFns<DeleteMapEntity_Response> = {
  encode(_: DeleteMapEntity_Response, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DeleteMapEntity_Response {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetMapEntity: MessageFns<SetMapEntity> = {
  encode(message: SetMapEntity, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.request !== undefined) {
      SetMapEntity_Request.encode(message.request, writer.uint32(10).fork()).join();
    }
    if (message.response !== undefined) {
      SetMapEntity_Response.encode(message.response, writer.uint32(18).fork()).join();
    }
    if (message.error !== undefined) {
      writer.uint32(26).string(message.error);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetMapEntity {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetMapEntity_Request: MessageFns<SetMapEntity_Request> = {
  encode(message: SetMapEntity_Request, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.entity !== undefined) {
      MapEntityDto.encode(message.entity, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetMapEntity_Request {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetMapEntity_Response: MessageFns<SetMapEntity_Response> = {
  encode(_: SetMapEntity_Response, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SetMapEntity_Response {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetAllMapEntities: MessageFns<GetAllMapEntities> = {
  encode(message: GetAllMapEntities, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.request !== undefined) {
      GetAllMapEntities_Request.encode(message.request, writer.uint32(10).fork()).join();
    }
    if (message.response !== undefined) {
      GetAllMapEntities_Response.encode(message.response, writer.uint32(18).fork()).join();
    }
    if (message.error !== undefined) {
      writer.uint32(26).string(message.error);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetAllMapEntities {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetAllMapEntities_Request: MessageFns<GetAllMapEntities_Request> = {
  encode(_: GetAllMapEntities_Request, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetAllMapEntities_Request {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetAllMapEntities_Response: MessageFns<GetAllMapEntities_Response> = {
  encode(message: GetAllMapEntities_Response, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.entities) {
      MapEntityDto.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetAllMapEntities_Response {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
